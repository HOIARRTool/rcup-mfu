...
def render_login():
    ...
    with right_col:
        ...
        info_html = (
            '<div class="login-info-card">'
              '<div class="login-badge">อ้างอิงมาตรฐานสถานพยาบาลปฐมภูมิ (สรพ.)</div>'
        
              '<div class="login-paragraph">'
                'สนับสนุนการขับเคลื่อนคุณภาพตาม <strong>ตอนที่ III-(1) การบริหารความเสี่ยงและความปลอดภัย</strong> '
                'และ <strong>ตอนที่ III-(5) ระบบการจัดการด้านยา</strong> '
              ...
              '<div class="feature-list">'
                ...
                '<div class="feature-item">'
                  ...
                  '<div class="feature-desc">คืนข้อมูลสู่คนทำงาน เข้าถึง Dashboard เพื่อค้นหาสาเหตุรากเหง้า (Root Cause) ประเมินสถานการณ์ได้ทันที</div>'
                '</div>'
              ...
              '<div class="quote-box">'
                ...
                'ทุกข้อมูลคือโอกาส... มาร่วมสร้าง <strong>วัฒนธรรมความปลอดภัย (Safety Culture)</strong> '
                'ที่แข็งแกร่ง เพื่อยกระดับมาตรฐานการดูแลพี่น้องประชาชนในชุมชนของคุณ'
              '</div>'
            '</div>'
        )
